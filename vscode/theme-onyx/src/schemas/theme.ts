...
export const FontStyleSchema = z.union([
  ...
  z
    .string()
    .regex(
      /^(normal|italic|bold|underline|strikethrough)(\s+(normal|italic|bold|underline|strikethrough))*$/,
    ),
]);
 ...
 */
export const SemanticTokenColorsSchema = z.record(
  z.string(),
  z.union([SemanticTokenColorSettingsSchema, ColorSchema]),
);
